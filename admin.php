                        ...
                        <form class="ltr:text-left rtl:text-right form-horizontal" id="loginForm" action="submit_login.php" method="post">
                            <div class="grid grid-cols-1">
                                <div class="mb-4">
                                    ...
                                    <input type="email" id="company_email" name="company_email" class="form-input mt-3" placeholder="Enter email" />
                                </div>
                                <div class="mb-4">
                                    <label class="font-semibold" for="LoginEmail">Password*</label>
                                    <input type="password" id="company_password" name="company_password" class="form-input mt-3" placeholder="Enter password" />
                                </div>
