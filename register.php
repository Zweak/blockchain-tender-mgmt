            ...
            <div class="container">
                ...
                <div class="flex justify-center">
                    ...
                    <div class="max-w-[400px] w-full m-auto p-6 bg-white dark:bg-slate-900 shadow-md dark:shadow-gray-800 rounded-md">
                        ...
                        <form class="ltr:text-left rtl:text-right form-horizontal" id="registerForm" action="submit_register.php" method="post">

                            <div class="grid grid-cols-1">

                                <div class="mb-4">

                                    <label class="font-semibold" for="LoginEmail">Company Name*</label>

                                    <input type="text" id="company_name" name="company_name" class="form-input mt-3" placeholder="Enter company name" />
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="submit" class="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md w-full" value="Register" id="loginbtn" />
                                ...
                                <div class="text-center">
                                    ...
                                    <span class="text-slate-400 ltr:mr-2 rtl:ml-2">Already have an account ?</span> <a href="login.php" class="text-black dark:text-white font-bold inline-block">Sign In</a>
